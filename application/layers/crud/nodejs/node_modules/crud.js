...
exports.updateItem = (Key, updateMap) => {
    ...
    return DynamoDB.update(
        { TableName, Key, UpdateExpression, ExpressionAttributeValues, ReturnValues },
